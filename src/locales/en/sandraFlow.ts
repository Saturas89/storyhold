...
export const SANDRA_FLOW_EN: SandraFlowStrings = {
  ...
  share: {
    ...
    copied: '✓ Link copied!',
    error: '⚠ Try again',
    copyCta: 'Just copy the link',
    copyAgain: 'Copy link again',
    copyError: "Copying didn't work – please try again.",
    sentTitleShare: 'Your link is on its way to {anrede} 💌',
    sentTitleCopy: '✓ Link copied!',
    sentCopyHint: 'Now send it to {anrede} – for example via WhatsApp or email.',
    sentNextSteps: "As soon as {anrede} opens the link and answers, you're connected automatically – you'll find {anrede} on the Family tab afterwards.",
    done: 'Done',
